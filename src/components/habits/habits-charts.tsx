      ...
      <Card>
        <CardContent className="p-12">
          <div className="text-center">
            <h3 className="text-lg font-medium text-muted-foreground">No data to display</h3>
            <p className="text-sm text-muted-foreground mt-2">Start tracking habits to see analytics.</p>
          </div>
        </CardContent>
      </Card>
    )
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={streakData} layout="horizontal">
              ...
              <Tooltip cursor={false} formatter={(value) => [`${value} days`, "Streak"]} />
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={completionRateData} layout="horizontal">
              ...
              <YAxis dataKey="name" type="category" width={100} />
              <Tooltip cursor={false} formatter={(value) => [`${value}%`, "Completion Rate"]} />
